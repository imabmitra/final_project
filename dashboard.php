...
<body>
<div class="div1"  ><h1>IOT based home appliance control (dashboard)</h1><div><p align="right">
  <input class="button3" type="button" value="Log Out" onclick="window.location.href='logout.php';"/>
</p></div> </div>
<div class="time">
...
echo('<div class="bar"><h1>Device Status</h1></div>');
